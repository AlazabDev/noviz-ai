 ...
 * flipping LLM_PROVIDER — see providers/llm/llmProviderFactory.ts,
 * which is what agent.routes.ts actually calls (azureFoundryProvider.ts
 * is the other concrete implementation today) — reasoningEngine.ts
 * never changes.
 *
